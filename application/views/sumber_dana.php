            ...
            <div class="row">
              <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_panel">
                  ...
                  <div class="x_content">                    
                    <form class="form-horizontal form-label-left" method="post" action="<?php echo base_url(); ?>index.php/sumberdana/simpan" novalidate>
                      <input type="hidden" name="id" id="id" value="<?php echo $form['id']; ?>" />
                      <div class="item form-group">
                        <label for="namasatker" class="control-label col-md-3 col-sm-3 col-xs-12">Nama Sumberdana <span class="required">*</span></label>
                      ...
                      <div class="form-group">
                        <div class="col-md-6 col-md-offset-3">
                            ...
                            <a href="<?php echo base_url(); ?>index.php/sumberdana/index" class="btn btn-dark">Reset</a>
                      ...
                      ?>
                        <tr>
                          ...
                          <td style="text-align: center; width: 40px">
                              <a href="<?php echo base_url() . "index.php/sumberdana/index/" . $d->id; ?>"><img src="<?php echo base_url() . 'images/application_form_edit.png'; ?>" /></a>
                              <a onclick="javascript:confirm('Hapus data program?')" href="<?php echo base_url() . "index.php/sumberdana/hapus/" . $d->id; ?>"><img src="<?php echo base_url() . 'images/cross.png'; ?>" /></a>
                          </td>
                        </tr>
                        <?php
                          $i++;
