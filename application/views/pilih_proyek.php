                    ...
                    <table id="datatable-buttons" class="table table-striped table-bordered">
                      ...
                      ?>
                        <tr>
                          ...
                          <td><?php echo number_format($d->nilai_kontrak, 2, ',' , '.'); ?></td>
                          ...
                          <td style="text-align: center; width: 40px">
                              <a href="<?php echo base_url() . "index.php/proyek/form/" . $rup_id . "/" . $id . "/" . $d->no_urut; ?>"><img src="<?php echo base_url() . 'images/accept.png'; ?>" /></a>                               
                          </td>
                        </tr>
                        <?php
                        $i++;
