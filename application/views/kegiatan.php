          ...
          <div class="">
            ...
            <div class="row">
              <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_panel">
                  <div class="x_title">
                    <h2>Tambah/Ubah Kegiatan Tahun Anggaran <?php echo $this->session->userdata('tahun_anggaran'); ?></h2>                    
                  ...
                  <div class="x_content">                    
                    <form class="form-horizontal form-label-left" method="post" action="<?php echo base_url(); ?>index.php/kegiatan/simpan" novalidate>                      
                      <input type="hidden" name="id" id="id" value="<?php echo $form['id']; ?>" />
                      <div class="item form-group">
                        <label class="control-label col-md-3 col-sm-3 col-xs-12" for="kdkegiatan">Program <span class="required">*</span>
                        </label>
                        <div class="col-md-6 col-sm-6 col-xs-12">
                            <select class="form-control col-md-7 col-xs-12 select2_program" required="required" name="program_id" id="program_id">
                                <option></option>
                                <?php
                                foreach($program as $p) {
                                    ?>
                                    <option <?php echo $p->id == $program_id ? "selected=\"selected\"" : ""; ?> value="<?php echo $p->id; ?>"><?php echo $p->kdprogram . ' - ' . $p->namaprogram; ?></option>
                                    <?php
                                }
                                ?>
                            </select>
                      ...
                      <div class="item form-group">
                        <label class="control-label col-md-3 col-sm-3 col-xs-12" for="kdkegiatan">Kode Kegiatan <span class="required">*</span>
                        </label>
                        <div class="col-md-6 col-sm-6 col-xs-12">
                            <input type="text" value="<?php echo $form['kdkegiatan']; ?>" name="kdkegiatan" id="kdkegiatan" class="form-control col-md-7 col-xs-12" required="required" />
                        </div>
                      </div>                                           
                      <div class="item form-group">
                        <label for="namaprogram" class="control-label col-md-3 col-sm-3 col-xs-12">Nama Kegiatan <span class="required">*</span></label>
                        <div class="col-md-6 col-sm-6 col-xs-12">
                            <input type="text" value="<?php echo $form['namakegiatan']; ?>" name="namakegiatan" id="namakegiatan" class="form-control col-md-7 col-xs-12" required="required" />
                        </div>
                      </div>                      
                      ...
                      <div class="form-group">
                        <div class="col-md-6 col-md-offset-3">
                            ...
                            <a href="<?php echo base_url(); ?>index.php/kegiatan/index" class="btn btn-dark">Reset</a>
                  ...
                  <div class="x_content">                    
                    <table id="datatable-buttons" class="table table-striped table-bordered">
                      ...
                      ?>
                        <tr>
                          <td><?php echo $i; ?></td>
                          <td><?php  echo $d->kdkegiatan; ?></td>                          
                          <td><?php echo $d->namakegiatan; ?></td>
                          <td style="text-align: center; width: 40px">
                              <a href="<?php echo base_url() . "index.php/kegiatan/index/" . $d->program_id . "/" . $d->id; ?>"><img src="<?php echo base_url() . 'images/application_form_edit.png'; ?>" /></a>
                              <a onclick="javascript:confirm('Hapus data kegiatan?')" href="<?php echo base_url() . "index.php/kegiatan/hapus/" . $d->id; ?>"><img src="<?php echo base_url() . 'images/cross.png'; ?>" /></a>                               
                          </td>
                        </tr>
                        <?php
                          $i++;
